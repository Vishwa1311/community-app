(function (module) {
    mifosX.controllers = _.extend(module, {
        NewLoanAccAppController: function (scope, routeParams, resourceFactory, location, dateFilter, uiConfigService, WizardHandler, route, $scope, $rootScope, $compile) {
    ...
    mifosX.ng.application.controller('NewLoanAccAppController', ['$scope', '$routeParams', 'ResourceFactory', '$location', 'dateFilter', 'UIConfigService', 'WizardHandler', '$route', '$scope', '$rootScope', '$compile', mifosX.controllers.NewLoanAccAppController]).run(function ($log) {
